...
// http://localhost:8000/home/books/
// router.post('/books/many', async (req, res) => {
//     try {
//         const books = req.body;
//          const createdBooks = [];

//         for (const bookData of books) {
//             const { title, author, description, publishedYear } = bookData;
//             const newUser= new User({ title, author, description, publishedYear });
//             await newUser.save();
//             createdBooks.push(newUser);
//         }

//         res.status(201).json({ message: 'Books created successfully', books: createdBooks });
//     } catch (error) {
